        ...
        <div class="col-lg-8 col-12 pad-btm-30">
            <ol class="checkin">
                ...
                <li>
                    ...
                    anda boleh menghubungi ASAYO KL di <a href="{{setting("contact.whatsapp")}}" target="_blank" rel="noopener noreferrer">{{setting("contact.phone")}}</a>.<br>
                    <span>
                        ...
                        you may contact ASAYO KL at <a href="{{setting("contact.whatsapp")}}" target="_blank" rel="noopener noreferrer">{{setting("contact.phone")}}</a>.
                    </span>
                </li>
