...
<div class="form-group row">
    <div class="col-lg-12">
        ...
        <input class="form-control" name="phone" placeholder="e.g. +6013-1234567" required />
    </div>
</div>
...
<div class="form-group row">
    <div class="col-lg-12">
        ...
        <input class="form-control" name="relation" required />
    </div>
</div>
...
<div class="form-group row">
    <div class="col-lg-12">
        ...
        <input class="form-control" name="nameChild" required />
    </div>
</div>
...
<div class="form-group row">
    <div class="col-lg-12">
        <label>Nombor Telefon <br> <span><i>Contact Number</i></span></label>
        <input class="form-control" name="phoneChild" placeholder="e.g. +6013-1234567" required />
    </div>
</div>
...
<div class="form-group row">
    <div class="col-lg-12">
        <label>Emel <br> <span><i>Email</i></span></label>
        <input class="form-control" type="email" name="emailChild" required />
    </div>
</div>
