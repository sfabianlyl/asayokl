...
@section("content")
    ...
    <ol>
        ...
        <li>   
            ...
            You are required to upload the proof of transfer during registration. If you have any enquiries about the payment or are in need of assistance, feel free to contact us at <a href="mailto:{{setting("contact.kamikudus")}}" target="_blank">{{setting("contact.kamikudus")}}</a> or Whatsapp us at <a href="{{setting("contact.whatsapp")}}" target="_blank" rel="noopener noreferrer">{{setting("contact.phone")}}</a>.
        </li>
        <li>
            What if I can’t make the indicated contribution during registration? <br><br>
            You may make an initial contribution of RM20 and contact us at <a href="mailto:{{ setting("contact.kamikudus") }}" target="_blank">{{ setting("contact.kamikudus") }}</a> or Whatsapp us at <a href="{{ setting("contact.whatsapp") }}" target="_blank" rel="noopener noreferrer">{{ setting("contact.phone") }}</a> for further arrangements.
